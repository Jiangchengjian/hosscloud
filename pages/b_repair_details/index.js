      ...
      success: res => {
        if (res.data.status == 200) {
          ...
          this.setData({
            ...
            creatTime: res.data.results.creatTime.split(" "),
            schedulStringTime: res.data.results.schedulStringTime.split(" "),
            accecpStringTime: res.data.results.accecpStringTime.split(" "),
            completeStringTime: res.data.results.completeStringTime.split(" "),
            endStringTime: res.data.results.endStringTime.split(" ")
          });
        } else {
